...
Please read these guidelines before contributing to meziantou/Meziantou.FileSharing:
...
If you have questions about how to use meziantou/Meziantou.FileSharing, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/Meziantou.FileSharing's existing code formatting and naming standard
- Run meziantou/Meziantou.FileSharing's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/Meziantou.FileSharing you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
